 ...
 * @param <S> The generic type of the TableView (for example a VorbisCommentTagField)
...
public abstract class AutoCommitTableCell<S,T> extends TableCell<S,T>
{
    ...
    public void cancelEdit() {
        ...
        System.out.println("Committing by leaving cell... " + Thread.currentThread().getStackTrace()[2].getClassName() + "/" + Thread.currentThread().getStackTrace()[2].getMethodName());
        ...
        if (field == null)    {
            ...
            field.addEventFilter(KeyEvent.KEY_PRESSED, event -> {
                if (event.getCode() == KeyCode.ENTER || event.getCode() == KeyCode.TAB){
                    System.out.println("Committing by pressing enter... " + Thread.currentThread().getStackTrace()[2].getClassName() + "/" + Thread.currentThread().getStackTrace()[2].getMethodName());
                    commitEdit(getInputValue());
                }
